...
URL=http://developer.download.nvidia.com/compute/cuda/6_5/rel/installers/cuda-repo-l4t-r21.3-6-5-prod_6.5-34_armhf.deb

#wget ${URL}

sudo dpkg --force-all -i cuda-repo-l4t-r21.3-6-5-prod_6.5-34_armhf.deb
